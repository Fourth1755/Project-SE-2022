<?php
    ...
    'petition'=>['index','newPetition','addPetition','indexSummaryPetition','approvePetition','approveView','approveApprove','newCompany','addCompany','searchPetition','searchPetitionDate','searchApprove'],
