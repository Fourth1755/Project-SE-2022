...
<body>
  <div>
      ...
      <div class="search-box">
        ...
        <div class="dropdown" style="padding-left: 40px;">
          ...
          <ul class="dropdown-menu" aria-labelledby="dropdownMenuButton1">
            ...
            <li><a class="dropdown-item" href="?key=2563&controller=petition&action=searchApprove">2562</a></li>
            <li><a class="dropdown-item" href="?key=2563&controller=petition&action=searchApprove">2561</a></li>
          </ul>
        </div>
      </div>
    </form>
    ...
    <table class="table" id="table-header">
      <tr>
        <th><a href="?controller=petition&action=SortDate"><?php echo "วันที่"; ?></th>
        <th>ปีการศึกษา</th>
        <th>รหัสนิสิต</th>
        <th>ชื่อ</th>
        <th>บริษัทฝึกงาน</th>
