  ...
  <div>
      ...
      <div class="search-box">
        ...
        <div class="dropdown" style="padding-left: 40px;">
          ...
          <ul class="dropdown-menu" aria-labelledby="dropdownMenuButton1">
            ...
            <li><a class="dropdown-item" href="?key=2562&controller=petition&action=searchPetition">2562</a></li>
          </ul>
        </div>
      </div>
    </form>
    <table class="table" id="table-header">
      <tr method="get" action="">
        <th><a href="?controller=petition&action=SortDate&key1=1" style="color: #000; text-decoration: none;"><i class="fas fa-chevron-down"></i><?php echo " วันที่ยื่นขอ"; ?></th>
        <th>ปีการศึกษา</th>
        <th>รหัสนิสิต</th>
        <th>ชื่อ</th>
        <th>บริษัทที่ฝึก</th>
