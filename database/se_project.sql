...
--
-- Host: 127.0.0.1
-- Generation Time: Mar 07, 2022 at 05:15 PM
...
INSERT INTO `company` (`ID`, `name`, `address`, `type`, `phoneNumber`, `faxNumber`) VALUES
(1, 'บริษัท โกไฟว์ จำกัด', '30/88 หมู่ที่ 1 ถ.เจษฎาวิถี ตำบลโคกขาม อำเภอเมืองสมุทรสาคร จังหวัดสมุทรสาคร 74000', 'บริษัทจำกัด', '027845855', '4562369876'),
(2, 'บริษัท บิท โซลูชั่น จำกัด', '454 ถ.รัชดาภิเษก\r\nแขวงสามเสนนอก เขตห้วยขวาง กรุงเทพมหานคร 10310', 'บริษัทจำกัด', '029381602', '029381618'),
(3, 'Drone Academy Thailand', '58/64 เมืองทองธานี ต. คลองเกลือ อ.ปากเกร็ด จ.นนทบุรี 11120\r\n', 'บริษัทจำกัด', '020000199', '1239567894');
...
INSERT INTO `requestform` (`ID`, `requestID`, `status`, `createDate`, `phoneNumber`, `facebookName`, `positionRequest`, `agentName`, `agentPosition`, `HR_Name`, `HR_PhoneNamber`, `HR_Email`, `startDate`, `endDate`, `approverID`, `companyID`) VALUES
(10001, 'b6220503201', 'waiting', '2022-03-07', '0321234567', 'Bie Juntawong', 'Network Engineer', 'อดิศักดิ์ วิชชุปัญญาพาณิชย์', 'Head of Engineer', 'อรชพร กอหามะ', '0856498531', 'bitsolution@gmail.com', '2022-04-18', '2022-06-10', NULL, 2),
(10002, 'b6220504666', 'waiting', '2022-03-07', '0321234567', 'Dream Wongtungjaroensuk', 'Mobile Developer', 'อดิศร จรัสโยธินนุวัฒน์', 'Human Resources Department Manager', 'Supanida Ouamprathum', '0836516795', 'internship@gofive.co.th', '2022-04-18', '2022-06-10', NULL, 1),
(10003, 'b6220504771', 'waiting', '2022-03-07', '0891684952', 'Meaw Apirakausanee', 'Data Engineer', 'ชัยวัฒน์ ประสิทธิพิพัฒน์', 'senior data engineer', 'ภูผา อธิษฐ์โภคิน', '0984561237', 'droneacademy@gmail.com', '2022-04-18', '2022-06-10', NULL, 3);
...
INSERT INTO `user` (`username`, `password`, `position`, `firstName`, `lastName`) VALUES
('A7527000001', 'sasitorn7527', 'admin', 'ศศิธร', 'ชลรัตน์อมฤต'),
('b6220503201', 'bie0503201', 'student', 'ณัฐวรรธน์', 'จันทวงศ์'),
('b6220504631', 'ploy0504631', 'student', 'ชัชชญา', 'พรมรินทร์'),
('b6220504666', 'dream0504666', 'student', 'ธนพัฒน์', 'วงษ์ตั้งเจริญสุข'),
('b6220504755', 'fourth0504755', 'student', 'ภูริวัฒน์', 'ภูลับ'),
('b6220504771', 'meaw0504771', 'student', 'ลลิตา', 'อภิรักษ์อุษณีย์'),
('T9043000001', 'boonyaratE9043', 'lecturer', 'อ.ดร.บุญรัตน์', 'เผดิมรอด');
